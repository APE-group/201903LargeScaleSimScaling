...
const std::string
nestmldev::name(void) const
{
  return std::string("nestmldev"); // Return name of the module
}

const std::string
nestmldev::commandstring( void ) const
{
  // Instruct the interpreter to load nestmldev-init.sli
  return std::string( "(nestmldev-init) run" );
}

//-------------------------------------------------------------------------------------
void
nestmldev::init( SLIInterpreter* i )
{
  
    nest::kernel().model_manager.register_node_model<aeif_custom>("aeif_custom");
  
    nest::kernel().model_manager.register_node_model<iaf_lifca>("iaf_lifca");
