...
public:
    ...
    void initPointerToGlobalDynamicParametersAwareness
       (DPSNN_dynamicParameters * const pLnp_dynPar);
    ...
    void synapseSetLastActiveTime_antiCausalSTDP(synapseClass *pointerActiveSynapse, const int32_t thisSimTimeStep_ms);
    void regularDynamicTimeStep(const int32_t thisTimeStep_ms, const float *pInputDistrib, uint32_t * pThalInputCounter); 
    //bool didItFire();
    ...
    void causalSTDP_ms_ofBackwardSynapses(const int32_t thisNeuronLastSpike_ms);
