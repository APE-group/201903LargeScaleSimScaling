...
enum modulationsIndexEnum {
  additionalFatigueAmplitudeEnum=0,
  additionalFatigueTransition_msEnum,
  additionalFatigueStationary_msEnum,
  multiplierInhCurrentExtremeEnum,
  multiplierInhCurrentTransition_msEnum,
  multiplierInhCurrentStationary_msEnum,  
  multiplierExcCurrentExtremeEnum,
  multiplierExcCurrentTransition_msEnum,
  multiplierExcCurrentStationary_msEnum,  
  numOfModulationsParamsEnum
};

struct modulationsStruct {
  float additionalFatigueAmplitude;
  float additionalFatigueTransition_ms;
  float additionalFatigueStationary_ms;
  float multiplierInhCurrentExtreme;
  float multiplierInhCurrentTransition_ms;
  float multiplierInhCurrentStationary_ms;  
  float multiplierExcCurrentExtreme;
  float multiplierExcCurrentTransition_ms;
  float multiplierExcCurrentStationary_ms;  
};

struct fatigueDynamicStruct {
  float additionalFatigue;
};

struct inputCurrentDynamicStruct {
  float multiplierInhCurrent;
  float multiplierExcCurrent;
};
  
struct DPSNN_dynamicParameters {
  fatigueDynamicStruct fatigueDynamic;
  inputCurrentDynamicStruct inputCurrentDynamic;
};
...
struct DPSNN_parameters {
  ...
  uint32_t startModulations_ms;
  uint32_t stopModulations_ms;
  
  modulationsIndexEnum modulationsIndex;
  modulationsStruct modulations;
};
